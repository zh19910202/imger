...
async function initializeModules () {
    ...
    if (typeof initializeSmartComparisonManager === 'function') {
        ...
        // 创建全局代理变量，确保与SmartComparisonManager状态同步
        setupSmartComparisonProxies()
    } else {
...
// 设置SmartComparisonManager的全局代理变量（解决跨页面对比图遗留问题）
function setupSmartComparisonProxies () {
    // 为了保持向后兼容性，提供代理访问器
    ...
    console.log('✅ SmartComparisonManager 代理变量已设置')
}
